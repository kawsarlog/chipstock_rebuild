...
# ── Service detail pages (mirror chipstock.com/our-services/<slug>/) ──────────
_WHY_WORK_ITEMS = [
    {
...
SERVICE_DETAIL = {
    "shortage-sourcing": {
        "name": "Shortage Sourcing",
        "title_html": '<h2><span style="color: #7d7d80;">Why</span> work with us?</h2>',
        "subtitle": "Solving shortages. Sourcing smarter. Delivering without compromise.",
        "items": _WHY_WORK_ITEMS,
    },
    "obsolete-end-of-life-sourcing": {
        "name": "Obsolete / End-of-Life Sourcing",
        "title_html": '<h2><span style="color: #7d7d80;">Why</span> work with us?</h2>',
        "subtitle": "Solving shortages. Sourcing smarter. Delivering without compromise.",
        "items": _WHY_WORK_ITEMS,
    },
    "factory-direct": {
        ...
        "items": [
            ...
            },
            {
                ...
                "img": "smart-microchip-background-motherboard-closeup-technology-5.webp",
                "text": "For components requiring deeper validation, we partner with certified third-party labs to conduct advanced testing in line with AS6081 and IDEA-STD-1010 standards. These procedures include X-ray imaging, XRF material analysis, blacktop and acetone testing, solderability assessments, and chemical decapsulation. When needed, we also perform electrical and functional testing. This level of scrutiny helps detect counterfeits, identify remarking, and verify that every part performs as expected under real-world conditions.",
            },
            {
...
def service_detail(slug):
    page = SERVICE_DETAIL.get(slug)
    if not page:
        abort(404)
    return render_template("service_detail.html", page=page, slug=slug)
